...
import 'package:eat_my_url/Components/colors.dart';
...
class ShortenInput extends StatefulWidget {
  const ShortenInput({
    Key? key,
  ...
  @override
  State<ShortenInput> createState() => _ShortenInputState();
}

class _ShortenInputState extends State<ShortenInput> {
  @override
  Widget build(BuildContext context) {

    setWindowMaxSize(const Size(1381, 580));
